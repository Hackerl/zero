...
TEST_CASE("base64 encoding", "[encoding]") {
    REQUIRE_THAT(zero::encoding::base64::encode(nonstd::span<const std::byte>{}), Catch::Matchers::IsEmpty());
    REQUIRE(zero::encoding::base64::encode(as_bytes(nonstd::span{DATA})) == "aGVsbG8=");
}
