...
namespace zero::filesystem {
    ...
    tl::expected<void, std::error_code> copyFile(const std::filesystem::path &from, const std::filesystem::path &to);
    ...
    tl::expected<void, std::error_code> createDirectory(const std::filesystem::path &path);

    tl::expected<void, std::error_code>
    createDirectory(const std::filesystem::path &path, const std::filesystem::path &existing);

    tl::expected<void, std::error_code> createDirectories(const std::filesystem::path &path);
    ...
    tl::expected<void, std::error_code> remove(const std::filesystem::path &path);
