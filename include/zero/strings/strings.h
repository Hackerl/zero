...
namespace zero::strings {
    ...
    std::expected<std::string, std::error_code> encode(std::wstring_view str, const char *encoding = "UTF-8");
    std::expected<std::wstring, std::error_code> decode(std::string_view str, const char *encoding = "UTF-8");
