...
std::expected<bool, std::error_code> zero::filesystem::createDirectory(const std::filesystem::path &path) {
    std::error_code ec;
...
std::expected<bool, std::error_code> zero::filesystem::createDirectories(const std::filesystem::path &path) {
    std::error_code ec;
...
std::expected<bool, std::error_code> zero::filesystem::remove(const std::filesystem::path &path) {
    std::error_code ec;
